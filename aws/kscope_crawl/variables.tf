...
variable "crawl_config_id" {
  description = "ID for the events generated by the platform"
  type        = string
}

variable "event_sqs_ingress_queue_arn" {
  description = "The arn of the SQS queue that will be used to receive events from the platform"
  type        = string
}
